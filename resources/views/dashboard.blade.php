                            ...
                            <div class="card-body">
                                ...
                                <div class="direct-chat-messages">
                                    ...
                                    <div class="direct-chat-msg">
                                        ...
                                        <!-- /.direct-chat-infos -->
                                        <img class="direct-chat-img" src="{{asset('adminlte3/dist/img/user.png')}}"
                                ...
                                <div class="direct-chat-contacts">
                                    <ul class="contacts-list">
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" src="{{asset('adminlte3/dist/img/user.png')}}"
                                                    alt="User Avatar">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body p-0">
                                        <ul class="users-list clearfix">
                                            <li>
                                                <img src="{{asset('adminlte3/dist/img/user.png')}}" alt="User Image">
                                ...
                                <ul class="products-list product-list-in-card pl-2 pr-2">
                                    <li class="item">
                                        <div class="product-img">
                                            <img src="{{asset('adminlte3/dist/img/default-150x150.png')}}" alt="Product Image"
                                                class="img-size-50">
                                        </div>
